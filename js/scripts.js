...
$(function(){
  ...
  $("form#user_input_form").submit(function(event){
    ...
    var marukinRamen = new RestMaker(false, "Japanese", "beer-wine", "traditional", 2, "Marukin Ramen", "Japanese chain opening up for the first time in Portland.","marukin.jpg", "609 SE Ankeny St. A, Portland, OR 97214", "(503) 894-9021");
    var biwa = new RestMaker(false,"Japanese","full-bar", "fancy", 3,"Bamboo Sushi", "Good sushi!", "biwa.jpg", "215 SE 9th Ave, Portland, OR 97214", "(503) 239-8830");
